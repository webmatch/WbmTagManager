...
INSERT IGNORE INTO `wbm_data_layer_properties` (`id`, `module`, `parentID`, `name`, `value`) VALUES
  ...
  (16, 'frontend_detail_index', 106, 'name', '{$article.articleName|escape}'),
  (17, 'frontend_detail_index', 106, 'id', '{$article.ordernumber|escape}'),
  (18, 'frontend_detail_index', 106, 'price', '{$article.price_numeric}'),
  (19, 'frontend_detail_index', 106, 'brand', '{$article.supplierName|escape}'),
  (20, 'frontend_detail_index', 106, 'category', '{$sCategoryInfo.name|escape}'),
  (21, 'frontend_detail_index', 106, 'variant', '{$article.additionaltext|escape}'),
