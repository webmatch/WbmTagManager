...
INSERT IGNORE INTO `wbm_data_layer_properties` (`id`, `module`, `parentID`, `name`, `value`) VALUES
  ...
  (114, 'frontend_checkout_ajaxaddarticlecart', 28, 'name', '{dbquery select=''articlename'' from=''s_order_basket'' where=[''ordernumber ='' => $smarty.request.sAdd\, ''sessionID ='' => $smarty.session.Shopware.sessionId] order=[''id'' => ''DESC'']}'),
  (115, 'frontend_checkout_ajaxaddarticlecart', 28, 'brand', '{dbquery select=''name'' from=''s_articles_supplier'' where=[''id ='' => {dbquery select=''supplierID'' from=''s_articles'' where=[''id ='' => {dbquery select=''articleID'' from=''s_order_basket'' where=[''ordernumber ='' => $smarty.request.sAdd\, ''sessionID ='' => $smarty.session.Shopware.sessionId] order=[''id'' => ''DESC'']}]}]}'),
  ...
  (116 ,'frontend_checkout_ajaxdeletearticlecart', 37, 'name', '{dbquery select=''articlename'' from=''s_order_basket'' where=[''id ='' => {request_get param=''sDelete''}]}'),
  (117, 'frontend_checkout_ajaxdeletearticlecart', 37, 'brand', '{dbquery select=''name'' from=''s_articles_supplier'' where=[''id ='' => {dbquery select=''supplierID'' from=''s_articles'' where=[''id ='' => {dbquery select=''articleID'' from=''s_order_basket'' where=[''id ='' => {request_get param=''sDelete''}]}]}]}'),
  ...
  (118, 'frontend_checkout_cart', 44, 'category', '{dbquery select=''description'' from=''s_categories'' where=[''id ='' => {dbquery select=''categoryID'' from=''s_articles_categories'' where=[''articleID ='' => $sArticle.articleID]}]}'),
  ...
  (119, 'frontend_checkout_confirm', 56, 'category', '{dbquery select=''description'' from=''s_categories'' where=[''id ='' => {dbquery select=''categoryID'' from=''s_articles_categories'' where=[''articleID ='' => $sArticle.articleID]}]}'),
  ...
  (120, 'frontend_checkout_finish', 68, 'category', '{dbquery select=''description'' from=''s_categories'' where=[''id ='' => {dbquery select=''categoryID'' from=''s_articles_categories'' where=[''articleID ='' => $sArticle.articleID]}]}');
  ...
  (112,'frontend_index_index', 0, 'name', '{$sArticle.articleName|escape}'),