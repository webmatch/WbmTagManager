...
INSERT IGNORE INTO `wbm_data_layer_properties` (`id`, `module`, `parentID`, `name`, `value`) VALUES
  ...
  (88, 'frontend_listing_index', 100, 'ecomm_prodid', '["{/literal}{foreach $sArticles as $sArticle}{if !$sArticle@first}{34|chr}{/if}{$sArticle.ordernumber|escape}{if !$sArticle@last}{34|chr},{/if}{/foreach}{literal}"]'),
  ...
  (92, 'frontend_checkout_cart', 102, 'ecomm_prodid', '["{/literal}{foreach $sBasket.content as $sArticle}{if !$sArticle@first}{34|chr}{/if}{$sArticle.ordernumber|escape}{if !$sArticle@last}{34|chr},{/if}{/foreach}{literal}"]'),
  ...
  (97, 'frontend_search_defaultsearch', 104, 'ecomm_prodid', '["{/literal}{foreach $sSearchResults.sArticles as $sArticle}{if !$sArticle@first}{34|chr}{/if}{$sArticle.ordernumber|escape}{if !$sArticle@last}{34|chr},{/if}{/foreach}{literal}"]'),
